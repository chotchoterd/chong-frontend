    ...
    <div className="w-full max-w-screen-xl mx-auto p-3 md:py-3 bg-sky-800 shadow">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <ul className="flex flex-col sm:flex-row p-4 bg-sky-800">
          ...
          <li className="mx-3 my-2 sm:my-0 rounded hover:bg-gray-200 py-1 px-3 text-white hover:text-black border-b-4"><Link style={{ fontSize: '18px' }} href="#">Log-in</Link></li>
        </ul>
      </div>
    </div>
  );
